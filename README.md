...
Локальный запуск — `run_bot11.cmd` (см. раздел «Запуск»). Примечание: в портфолио один токен на все боты, поэтому одновременно в сети может находиться только один проект.
